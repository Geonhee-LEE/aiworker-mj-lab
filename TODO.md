...
- Last update: `2026-09-06 22:51 KST`
...
| MP-0031 | P2 | P5 | user | [research] 장애물 배치별 RRT-Connect vs RRT* 재검증 완료(PR #13) — 장애물 없음: 차이 없음(p=0.86). narrow_passage/cluttered: RRT*가 유의하게 더 짧은 경로(p<0.05)지만 성공률 78-88%로 하락(RRT-Connect는 100%) — 안정성-품질 트레이드오프. 문서 반영 여부·15초 예산 재검토는 사용자 판단 | planning/p5-planner-comparison | ☐ |

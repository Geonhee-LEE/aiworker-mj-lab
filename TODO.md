...
- Last update: `2026-09-05 11:08 KST`
- Open (Doing + Today + Blocked + Backlog): **22**
- Next ID: `MP-0031`
...
| MP-0016 | P2 | P5 | claude | [planner] `planning/rrt_star.py` 초안 — 구현·테스트 완료, PR #4 사람 리뷰 대기(PR #1/#2 병합 여파로 `__init__.py` 충돌 ... | planning/p5-rrt-star-planner | ☐ |
| MP-0024 | P1 | P2 | claude | [planner] CHOMP류 궤적 최적화 후처리(`planning/chomp.py`) — 구현·테스트 완료, PR #5 사람 리뷰 대기(PR #1/#2 병합 여파로 `__i... | planning/chomp-posture-smoothing | ☐ |
...
| MP-0029 | P2 | P7 | claude | [docs] P7.0/P7.1 가이드 문서화 — PR #12 사람 리뷰 대기 | docs/p7-mobile-manipulator-guide | ☐ |

...
SIDES = ("l", "r")
ARM_JOINTS = {
    side: tuple(f"arm_{side}_joint{index}" for index in range(1, 8))
    for side in SIDES
}
ACTION_NAMES = tuple(
    [*(f"left_arm_joint_{index}" for index in range(1, 8)), "left_grasp",
...
__all__ = [
    "ACTION_DIM", "ACTION_NAMES", "ARM_JOINTS", "ActionAdapter",
    "DecodedAction", "SIDES",
]

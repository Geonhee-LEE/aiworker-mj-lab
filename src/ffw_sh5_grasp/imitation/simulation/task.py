...
class CanInBoxTask:
    ...
    def reset(self, data, rng):
        ...
        # The task can be attached to an existing teleop ``MjData`` whose qpos
        # was just initialized. Refresh the fixed target site's world pose
        # before deriving the spawn anchor.
